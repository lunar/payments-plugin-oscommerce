...
describe('lunar plugin full test', () => {
    /**
    ...
    context(`make payments in "${captureModes[0]}" mode`, () => {
        /** Modify Lunar settings. */
        it(`change Lunar capture mode to "${captureModes[0]}"`, () => {
            TestMethods.changeLunarCaptureMode(captureModes[0]);
        });
    ...
    context(`make payments in "${captureModes[1]}" mode`, () => {
        /** Modify Lunar settings. */
        it(`change Lunar capture mode to "${captureModes[1]}"`, () => {
            TestMethods.changeLunarCaptureMode(captureModes[1]);
        });
